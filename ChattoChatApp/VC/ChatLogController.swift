...
//         let textMessage = TextWithButtonModel(messageModel: message, uid: msgUID, date: date, text: "GavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavinGavin", button: [UIButton(),UIButton()])
        
        let textMessage = TextWithButtonModel(messageModel: message, uid: msgUID, date: date, text: "Gavin", button: [UIButton(),UIButton()])
        
            
        
        //            let textMessage = TextModel(messageModel: message, text: "Gavin")
        //            self.dataSource.addMessage(message: textMessage)
        self.dataSource.addMessage(message: textMessage)
        //self?.sendOnlineTextMsg(text: , uid: msgUID, double: double, senderId: senderID)
    }
...
//        let textWithButtonBuilder = TextWithButtonPresenterBuilder(view)
        ...
        return [
            ...
            TextWithButtonModel.chatItemType:[TextWithButtonPresenterBuilder()],
    ...
    override func createChatInputView() -> UIView {
        ...
        //        let inputBar = InputBarUIView()
        
        
        //        let appearance = ChatInputBarAppearance()
        
        
        //        self.presenter = BasicChatInputBarPresenter(chatInputBar: inputBar, chatInputItems: [], chatInputBarAppearance: appearance)
...
extension ChatLogController {
    func array(_ array: FUICollection, didAdd object: Any, at index: UInt) {
        ...
        if contains == false {
            ...
            }else if type == TextWithButtonModel.chatItemType{
